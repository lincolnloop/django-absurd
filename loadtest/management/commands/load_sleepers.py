...
class Command(BaseCommand):
    ...
    def handle(self, *args: t.Any, **options: t.Any) -> str:
        ...
        for workload in workloads:
            for sleeper_count in (0, probe.sleepers):
                entry = self.measure_arm(probe, workload, sleeper_count)
    ...
    def report(
        ...
        self.stdout.write(
            ...
            f"{'sleeping_min':>14}{'running_max':>13}"
        )
...
def drain_quick_tasks(
    ...
    samples = wait_for_executions(worker, probe, probe.quick, sleeper_ids=sleeper_ids)
