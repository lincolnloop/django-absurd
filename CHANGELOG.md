...
**First stable release.** `pip install django-absurd` / `uv add django-absurd` now
resolves without `--pre`. The 1.0 API is frozen, and semantic versioning binds from
here: a breaking change means 2.0.0, not a minor bump.
